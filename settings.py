...
CHANNEL_ID = 1269944267 # id канала куда будет отсылаться информация, ид без -100 в начале (например: 124873248) - указать заместо нуля

# ID admin
admin_id = 310743892 # id админа - указать заместо нуля

bot_login = 'SMMYOUTUBE_BOT' # логин бота
ref_percent = 5 # Процент реферальной системы

QIWI_NUMBER = '+QIWI'    # номер киви
